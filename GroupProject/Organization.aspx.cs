...
public partial class Organization : System.Web.UI.Page
{
    ...
    protected void insertButton_Click(object sender, EventArgs e)
    {
        ...
        addOrgcmd.Parameters.AddWithValue("@OrgAddress", addOrgAddress.Text);
        ...
        addOrgcmd.Parameters.AddWithValue("@PrimaryContactPerson", addPerson.Text);
        addOrgcmd.Parameters.AddWithValue("@OrgPhone", addPhone.Text);
        addOrgcmd.Parameters.AddWithValue("@OrgEmail", addEmail.Text);
        addOrgcmd.Parameters.AddWithValue("@LastUpdatedBy", "Judy");
        addOrgcmd.Parameters.AddWithValue("@LastUpdated", DateTime.Today);
        addOrgcmd.Parameters.AddWithValue("@OrganizationName", addOrgName.Text);
    ...
    protected void UpdateButton_Click(object sender, EventArgs e)
    {
        ...
        updateOrgcmd.Parameters.AddWithValue("@OrgAddress", EditOrgAddress.Text);
        ...
        updateOrgcmd.Parameters.AddWithValue("@ContactPerson", EditPerson.Text);
        updateOrgcmd.Parameters.AddWithValue("@OrgPhone", EditPhone.Text);
        updateOrgcmd.Parameters.AddWithValue("@OrgEmail", EditEmail.Text);
        updateOrgcmd.Parameters.AddWithValue("@OrganizationName", EditOrgName.Text);
