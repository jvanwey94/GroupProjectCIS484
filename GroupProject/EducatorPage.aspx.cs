...
public partial class EducatorPage : System.Web.UI.Page
{
    ...
    {
        Educator newEdu = new Educator(addFN.Text, addLN.Text, addEmail.Text, addPhone.Text);
        ...
        string insert = "insert into [dbo].[Educator] values(@EducatorID, @FirstName, @LastName, @eduEmail, @eduPhone)";
    ...
    {
        Educator editEdu = new Educator(editFN.Text, editLN.Text, editEM.Text, editPH.Text);
        editEdu.setFN(editFN.Text);
        editEdu.setLN(editLN.Text);
        editEdu.setEM(editEM.Text);
        editEdu.setPH(editPH.Text);
        sc.Open();
        string update = "update [dbo].[Educator] set FirstName=@FirstName, LastName=@LastName, eduEmail=@eduEmail, eduPhone=@eduPhone where EducatorID=@EducatorID";
        SqlCommand updatecmd = new SqlCommand(update, sc);
        updatecmd.Parameters.AddWithValue("@EducatorID", EducatorGridView.SelectedRow.Cells[4].Text);
